...
- **Key feature**: 238 MCP tools for local binary analysis, optional BSim,
...
- Run tests before committing: `uv run pytest tests/unit/ -v --no-cov`
...
- Test (Python): `uv run pytest tests/unit/ -v --no-cov`
