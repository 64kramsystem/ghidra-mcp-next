...
- **229 MCP tools** — 3x more than any competing implementation. Not just read operations — full write access for renaming, typing, commenting, structure creation, script execution, P-code emulation, and live debugging.
...
- **229 MCP Tools** — Comprehensive API surface covering every aspect of binary analysis
...
- **MCP Tools**: 229 tools fully implemented
...
|--------|-------|
| **Version** | 5.15.0 |
| **MCP Tools** | 229 fully implemented |
