...
- **257 MCP tools** — 3x more than any competing implementation. Not just read operations — full write access for renaming, typing, commenting, structure creation, script execution, P-code emulation, and live debugging.
...
- **257 MCP Tools** — Comprehensive API surface covering every aspect of binary analysis
...
- **MCP Tools**: 257 tools fully implemented
