...
It currently contains 229 endpoints. Do not maintain a separate hand-count in
...
The 18 TraceRMI endpoints are in the `debugger` group. Static analysis is split
