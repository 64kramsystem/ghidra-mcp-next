/*
 * crc16.c — deterministic Ghidra benchmark function.
 *
 * This file is authored from scratch to exercise fixture compilation,
 * import, analysis, and endpoint regression checks end-to-end.
 */
